		        			...
		        			var outhtml;
				         	if(username_list.length == 0) { 
				            	...
				            	$.each(username_list.items, function(key,value) {
				            		...
				            		outhtml = outhtml + '<li>';
				            		outhtml = outhtml + '<a href="http://localhost/jquery_github_api/?username='+ value.login +'" target="_blank"><img src="'+ value.avatar_url +'" width="40" height="40" alt="'+ value.login +'"></a>';
				             		outhtml = outhtml + '<a href="http://localhost/jquery_github_api/?username='+ value.login +'" target="_blank"><h2>'+ value.login + '</h2></a>';
				             		outhtml = outhtml + '</li>';
				            	});
				            	outhtml = outhtml + '</ul>';
				            	outhtml = outhtml + '</div>'; 
